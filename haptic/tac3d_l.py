...
class Tac3DPublisher(Node):
    ...
    def __init__(self):
        ...
        self.publisher_forces = self.create_publisher(Array3, 'forces_l', 10)  # F数据 (Array3)
        self.publisher_resultant_force = self.create_publisher(Cloud, 'resultant_force_l', 10)  # Fr数据
        self.publisher_resultant_moment = self.create_publisher(Cloud, 'resultant_moment_l', 10)  # Mr数据
